          ...
          <div className="flex w-full flex-row justify-between items-center px-6">
            ...
            <div className="flex flex-row gap-2">
              <input
                ...
                className="h-fit rounded-2xl bg-white px-6 py-7 font-roboto text-base text-black_coral_pearl outline-none"
              />
              <Button
                variant="contained"
                className="rounded-2xl bg-blue_dianne px-12 py-7 font-roboto text-base font-bold capitalize hover:bg-blue_dianne"
              >
                Subscribe
              </Button>
            </div>
